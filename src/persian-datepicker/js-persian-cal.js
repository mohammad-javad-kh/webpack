/*
 ...
 @author Danial Mirzaei
 mirzai.danial@gmail.com
*/
(function (global, factory) {
  ...
  if ("undefined" === typeof NIBI) var NIBI = {};
  ...
  if (!fdef(cTN))
    var cTN = function(b) {
      return window.document.createTextNode(b);
    };
  NIBI.persianCalendar = function(b, a) {
    var c = {
        inputID: "",
        extraInputID: "",
        extraInputFormat: "JD",
  ...
  NIBI.persianCalendar.prototype.showHidePicker = function(b) {
    var a = this.inputID + "_pDatePicker",
      c;
    if ((c = A$(a))) {
      if (
        (c.parentNode.removeChild(c),
        (window.document.onclick = this.oldDocumentOnClick),
      ...
      stopPropg(b);
      this.oldDocumentOnClick = window.document.onclick;
      var e = this,
        g = b;
  ...
  NIBI.persianCalendar.prototype.createDateTable = function(b, a, c) {
    var d = cE("table"),
      e,
      g,
      f,
    ...
    c = isPersianDate(c);
    a = jd_to_persian(a);
    var l = window.Math.floor(persian_to_jd(a[0], a[1], 1) + 3) % 7;
    e = d.insertRow(-1);
    g = e.insertCell(-1);
  ...
  NIBI.persianCalendar.prototype.changePickerDate = function(b, a, c) {
    var d;
  ...
  NIBI.persianCalendar.prototype.showMonthPicker = function(b, a, c) {
    var d, e, g;
  ...
  NIBI.persianCalendar.prototype.showYearPicker = function(b, a, c) {
    var d, e, g;
    if (A$(this.inputID + "_pDatePicker")) {
      b || (b = window.event);
      (e = A$(lastOpenPDateMonthYearID)) && e.parentNode.removeChild(e);
  ...
  NIBI.persianCalendar.prototype.setMenuPos = function(b, a) {
    var c = getOffset(a);
    b.style.top =
  ...
  NIBI.persianCalendar.prototype.monthYearPickerClick = function(b, a, c) {
    var d, e;
    if ((d = A$(this.inputID + "_pDatePicker")))
      b || (b = window.event),
        stopPropg(b),
  ...
  NIBI.persianCalendar.prototype.normalizeUserInput = function() {
    var b = this.input,
      a,
      c = b.value.trim(),
      c = faDigitsToEn(c);
  ...
  NIBI.persianCalendar.prototype.fillDateField = function(b) {
    var a = this.input,
      c;
  ...
  NIBI.persianCalendar.prototype.keyDownHandler = function(b, a) {
    var c;
    b || (b = window.event);
    ...
    if (
      ...
      if (38 === c || 40 === c) {
        ...
        !1 !== d &&
          (38 === c
            ? a.fillDateField(
                jd_to_persian(persian_to_jd(d[0], d[1], d[2]) + 1)
              )
            : 40 === c &&
              a.fillDateField(
                jd_to_persian(persian_to_jd(d[0], d[1], d[2]) - 1)
  ...
  function persianMonthDays(b, a) {
    return 6 >= a
      ? 31
      : 11 >= a ? 30 : 12 == a ? (leap_persian(b) ? 30 : 29) : 0;
  }
  if (!fdef(stopPropg))
  ...
  if (isGlobal) {
    window.persianCalendar = NIBI.persianCalendar;
  }

  return NIBI.persianCalendar;
});
